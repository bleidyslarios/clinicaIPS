...
from .views import ejecutar_etl_view, subir_dataset, historial_etl, estadisticas_etl, exportar_dataset_csv, generar_dataset_view, reset_app_view
...
urlpatterns = [
    ...
    path('reset/', reset_app_view, name='etl_reset'),
]
